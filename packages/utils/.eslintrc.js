...
module.exports = {
  ...
  rules: {
     ...
     * 2 => error
     */
    //  quotes: ["error", "single"],//"single"要求尽可能使用单引号
    // quotes: ['error', 'double'], //"double"（默认）要求尽可能使用双引号
    ...
    '@typescript-eslint/no-explicit-any': 0, // 不允许显示的定义any类型。如：const str: any = '1'
    ...
    '@typescript-eslint/no-floating-promises': 0, // 要求必须处理Promise语句。
